...
export const experiences = [
    ...
    // },
    {
        ...
        'logo': 'http://www.nebula-technology.com/static/media/icon.75daecad9a880e223ba1.png',
        'points': [
            ...
            'Enhanced software development processes by using React, Javascript, HTML, CSS optimized code efficiency, reduced bug count.',
            ' Exhibits effective communication skills to express complex programming concepts clearly and concisely.',
        ],
        'url': 'http://www.nebula-technology.com/',
    },
]
